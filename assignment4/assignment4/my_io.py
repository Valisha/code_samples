...
"""
categories.py
Overview - Stores the categories of each gene in a different file
Run - python3 categories.py --help
"""

"""
my_io.py
Overview - Opens the main file and gets the protein
Run - python3 my_io.py --help
"""

"""
intersection.py
Overview - Opens both the files and stores common proteins and desription in another file
Run - python3 intersection.py --help
"""
